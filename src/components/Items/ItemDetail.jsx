...
function ItemDetail({productos}) {
    return (
        productos.map(p => (
        <section key={p.id} className="py-5">
            <div className="container px-4 px-lg-5 my-5">
                <div className="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div className="col-md-6">
                        ...
                        <h1 className="display-5 fw-bolder contact100-more-highlight">{p.nombre}</h1>
                        <div className="fs-5 mb-5">
                            <span className="text-decoration-line-through">$14.000</span>
                            <span>{p.precio}</span>
                        </div>
                        <p className="lead">{p.descripcion}</p>
                        <p className="lead">{p.categoria}</p>
                        <div className="d-flex">
                            <ItemCount stock={10} className={s.btnContainer}/>
                        </div>
                    </div>
                </div>
            </div>
